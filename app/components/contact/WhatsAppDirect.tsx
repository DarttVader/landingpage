...
export default function WhatsAppDirect({ phone = contacts[1].number }: WhatsAppDirectProps) {
  return (
    <a
      href={`https://api.whatsapp.com/send/?phone=${phone.replace(/\D/g, "")}&text=Ol%C3%A1!%20Gostaria%20de%20agendar%20uma%20consulta.`}
      target="_blank"
