...
export const treatments: Treatment[] = [
  ...
  {
    id: 10,
    title: "Profhilo | Bioestimulação e Hidratação Profunda",
    description: "Tratamento injetável inovador à base de ácido hialurônico puro, indicado para melhorar a qualidade da pele de forma global, promovendo hidratação intensa e estímulo de colágeno.\n\nPara quem é indicado:\n• Flacidez leve a moderada\n• Pele fina e sem viço\n• Perda de qualidade da pele\n• Início do envelhecimento\n• Pacientes que buscam naturalidade (sem volume)\n\nO que ele faz na pele:\n• Estimula colágeno e elastina\n• Melhora afirmesa e elasticidade\n• Promove hidratação profunda\n• Deixa a pele mais iluminada e viçosa\n• Melhora a textura de forma global\n\nComo funciona:\nAplicação em pontos estratégicos do rosto, com técnica específica, permitindo uma distribuição uniforme do produto na pele.\n\nNão é preenchedor - não altera o formato do rosto.",
    shortDescription: "Ácido hialurônico puro para bioestimulação e hidratação profunda",
    image: "/profhilo.jpg",
    featured: true,
  },
  {
    ...
    description: "Diagnóstico e tratamento das principais doenças de pele, cabelo e unhas.\n\n• Acne (adolescente e mulher adulta)\n• Rosácea\n• Dermatites\n• Melasma\n• Queda de cabelo / alopecia\n• Infecções cutâneas\n• Psoríase e doenças inflamatórias\n• Micose de pele e unhas",
    shortDescription: "Diagnóstico e tratamento de doenças de pele, cabelo e unhas",
    image: "/dermatologia.jpg",
    featured: true,
  },
  {
    id: 14,
    title: "Dermatologia Cirúrgica e Estética",
    description: "DERMATOLOGIA CIRÚRGICA\nProcedimentos para diagnóstico e tratamento de lesões cutâneas.\n• Biópsia de pele\n• Retirada de pintas e lesões suspeitas\n• Tratamento de câncer de pele\n• Pequenas cirurgias dermatológicas\n\nDERMATOLOGIA ESTÉTICA\nTratamentos voltados para rejuvenescimento e melhora da qualidade da pele.\n\nInjetáveis:\n• Toxina botulínica (Botox)\n• Preenchimento com ácido hialurônico\n• Bioestimuladores de colágeno (Sculptra, Radiesse, Profhilo)\n\nTecnologias e Aparelhos:\n• Laser Fotona Spectro (rejuvenescimento, manchas, flacidez, poros)\n• Ultrafomer (lifting sem cirurgia)\n• Tecnologias para estímulo de colágeno",
    shortDescription: "Procedimentos cirúrgicos e tratamentos estéticos",
    image: "/biopsia.jpg",
    featured: true,
  },
  {
